...
class Job:
    ...
    @classmethod
    def read_file(cls, path: Path) -> list[dict]:
        ...
        with fh:
            data = json.load(fh)
        return [flatten(r) for r in cls.get_records(data)]
...
class Main:
    ...
    def main(cls) -> None:
        ...
        parser.add_argument("in_dir", help="Root directory of log files")
